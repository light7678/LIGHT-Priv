...
numbernye = '0'
join = '\`\`\`Hola👋🏻, Bienvenido al grupo 🥳🎊\n Soy LIGHT 😎 el Bot del Grupo,espero ser de tu agrado, lee las reglas por favor para evitar malos entendidos 💣\n - [ LIGHT⚡NTR] -'
leave = setting.leave
...
Soy Turbo 😎 el bot del Grupo,espero ser de tu agrado
Lee las reglas por favor para evitar malos entendidos 💣
 - [ LIGHT 🥵NTR ] -
「 *DESCRIPCIÓN* 」
  ...
  ${mdata.desc}*`
				...
				teks = `*@${num.split('@')[0]}*
				Adios 🙋🏻‍♂️ nadie te queria, no vuelvas por favor 😹
${leave}	`
...
࣪✦˖꒷꒦⏝࣪꒷꒦꒦꒷꒦⏝⏝꒦꒷˖ ࣪✦
        ♕MENU COMPLETO♕
CANAL: https://youtube.com/channel/UC55uJfxI_YtCPztltcsgsjA
  ...
  //********** SELF&PRIVATE **********//
			  ...
			  case 'public':
				...
				TurboNtr.updatePresence(from, Presence.composing) 
					...
					TurboNtr.sendMessage(from, wew, image, { caption: '*ᎮᎥᏒᎧᎮᎧᏕ👌*\n\n'+ js, quoted: mek })
break  
			    case 'mute':
                if (!mek.key.fromMe) return reply('*No eres mi dueño Turbo >n<*')
		...
		break
            ...
            case 'delthischat':
                ...
                break
case prefix+ 'lightgrupo':
buffer = await getBuffer(`https://telegra.ph/file/f5252cf0515addf52780b.jpg`)
					TurboNtr.sendMessage(from, buffer, image, {quoted: mek, caption: 'Link del grupo LIGHT, Todos son bienvenidos!! 🤗\n-https://chat.whatsapp.com/FZZkemMGBsm7zG8ZrLs43X', sendEphemeral: true, contextInfo: { forwardingScore: 1000, isForwarded: true }})
break
case 'grupo':
					case 'lightgrupo':
buffer = await getBuffer(`https://telegra.ph/file/a3d623676c5a237f4ac86.jpg`)
					TurboNtr.sendMessage(from, buffer, image, {quoted: mek, caption: 'Link del grupo LIGHT BOT OFC, Todos son bienvenidos!! 🤗\n-https://chat.whatsapp.com/FZZkemMGBsm7zG8ZrLs43X', sendEphemeral: true, contextInfo: { forwardingScore: 1000, isForwarded: true }})
break
        ...
        case 'grup':
			...
			if (!isGroupAdmins) return reply(mess.only.admin)
					...
					if (mentioned.length > 1) {
						...
						mentions(teks, mentioned, true)
						light.groupRemove(from, mentioned)
					} else {
                ...
                if (!isGroupAdmins) return reply(mess.only.admin)
					...
					mentions(`*From :* - [ TURBO NTR-\n*Info :*  ${body.slice(9)}\n*Total Member :* ${groupMembers.length} \n\n┏━━━⟪ *INFORMATION* ⟫━━━┓`+teks+'╚═ *「 LIGHT 」* ', members_id, true)
					break
